...
const HeroSection = () => {
  ...
  // Duplicate many times for long seamless loop
  const duplicated = Array(32).fill(brands).flat();
    ...
    <section id="home" className="bg-[#E9E9E9] flex flex-col">
      ...
      <div className="bg-[#21597A] py-4 sm:py-5 md:py-6 overflow-hidden -mt-8 sm:-mt-6 md:-mt-16 lg:-mt-20 xl:-mt-20">
        <div className="relative overflow-hidden w-full">
          <div className="flex animate-scroll gap-12 sm:gap-16 md:gap-20 lg:gap-24 xl:gap-32 whitespace-nowrap">
            {duplicated.map((brand, idx) => (
              <div
                key={idx}
                className="flex-shrink-0 flex items-center justify-center opacity-95 hover:opacity-100 transition-opacity"
              >
                <Image
                  src={brand.src}
                  alt={brand.alt}
